{{-- el goz2 el sabt ely hawreso l kol el pages el tanya --}}
...
<head>
    ...
    {{-- akny 3raft variable fe el title bl yield --}}
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{url('dist/img/products/logoo.jpg')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">My Dashboard</a>
                    </div>
                </div>
